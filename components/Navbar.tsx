...
const Navbar = () => {
  ...
  return (
    ...
    > 
      ...
      <img src="/assets/images/NJUSTlogo.png" height ={"60px"} width={"60px"} style={{display:"inline"}} alt="" /> <span className="font-bold">Decentralized Online</span><span className="text-white font-bold"> Voting System</span> 
      </Link>
      {wallet ? (
        <button
