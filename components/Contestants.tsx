...
const Contestants: React.FC<{ contestants: ContestantStruct[]; poll: PollStruct }> = ({
  ...
  return (
    <div className="space-y-2">
      <h1 className="text-center text-[48px] font-[600px]">Candidates</h1>
  ...
  const voteContestant = async () => {
    ...
    await toast.promise(
      ...
      }),
      {
        ...
        success: 'Voted candidate successfully ✌️',
      ...
      >
        ...
        <div className="w-[90px] h-[32px] flex items-center justify-center gap-3">
          ...
          <p className="text-[14px] font-[600px]">
             {contestant.votes === 1 ? `${contestant.votes} vote` : `${contestant.votes} votes`}
          </p>
